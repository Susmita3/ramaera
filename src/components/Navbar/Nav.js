  ...
  return (
    <>
      <nav className="fixed top-0 w-full px-10 py-6 flex items-center flex-row justify-between ">
        ...
        {/* Menu part start */}
        <div className="flex flex-row items-center justify-between border rounded-2xl w-10/12 h-16 p-2 font-Montserrat backdrop-blur mr-16">
          <ul className="flex items-center justify-around w-6/12 text-lg ">
            <li>
              <NavLink to="/" className="text-white flex items-center gap-2 hover:text-[#E65C00]">
                HOME <SlArrowDown />
              </NavLink>
            </li>
            <li>
          ...
          <ul className="flex items-center flex-row justify-around w-3/12 text-lg hover:text-[#E65C00]">
            <li>
              <NavLink to="/" className="text-white text-lg hover:text-[#E65C00]">
                Career
              </NavLink>
            </li>
            <li>
